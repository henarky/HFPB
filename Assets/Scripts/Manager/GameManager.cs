...
//  Attempt to fix issue with spawning player and InputState not applying.
//        player = GameObjectUtil.Instantiate(playerPrefab, new Vector3(0, (Screen.height / PixelPerfectCamera.pixelsToUnits) / 4, 0));
